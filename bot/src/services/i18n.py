...
TEXTS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "devices_btn": "Устройства ({count}/{limit})",
        "devices_title": "Устройства ({count}/{limit})",
        "devices_empty": "Нет активных устройств.",
        "devices_hint": "Каждое устройство получает отдельный UUID. Максимум {limit} устройства одновременно.",
    ...
    "en": {
        ...
        "devices_btn": "Devices ({count}/{limit})",
        "devices_title": "Devices ({count}/{limit})",
        "devices_empty": "No active devices.",
        "devices_hint": "Each device gets a separate UUID. Maximum {limit} devices at a time.",
