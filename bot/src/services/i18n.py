...
TEXTS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "pay_sbp_button": "{rub}₽ СБП",
        "pay_sbp_button_soon": "{rub}₽ СБП (Скоро)",
        "sbp_soon": "Оплата по СБП скоро будет доступна. Пока что доступны Telegram Stars.",
        "sbp_invoice": "Оплата {rub}₽ по СБП за {days} дней.\nНажмите «Оплатить», затем вернитесь и нажмите «Проверить оплату».",
        "pay_now": "Оплатить",
        "sbp_check": "Проверить оплату",
        "sbp_pending": "Оплата ещё не поступила. Если вы только что оплатили, подождите минуту и нажмите «Проверить оплату» снова.",
        "sbp_canceled": "Платёж отменён. Оформите заказ заново.",
        "sbp_error": "Не удалось создать платёж. Попробуйте позже.",
        "sbp_already_paid": "Этот платёж уже подтверждён.",
        "sbp_confirmed_alert": "Оплата подтверждена. Ссылка отправлена в чат.",
    ...
    "en": {
        ...
        "pay_stars_button": "{stars} ⭐ Stars",
        "pay_sbp_button": "{rub}₽ SBP",
        "pay_sbp_button_soon": "{rub}₽ SBP (soon)",
        "sbp_soon": "SBP payments are coming soon. For now use Telegram Stars.",
        "sbp_invoice": "Payment {rub}₽ via SBP for {days} days.\nTap Pay, then come back and tap Check payment.",
        "pay_now": "Pay",
        "sbp_check": "Check payment",
        "sbp_pending": "Payment not received yet. If you just paid, wait a minute and tap Check payment again.",
        "sbp_canceled": "Payment canceled. Please start the order again.",
        "sbp_error": "Could not create the payment. Please try again later.",
        "sbp_already_paid": "This payment is already confirmed.",
        "sbp_confirmed_alert": "Payment confirmed. The link was sent to the chat.",
