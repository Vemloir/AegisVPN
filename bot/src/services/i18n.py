...
TEXTS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "pay_sbp_button": "Platega | {rub}₽",
        "pay_sbp_button_soon": "Platega | {rub}₽ (Скоро)",
        "sbp_soon": "Оплата рублями скоро будет доступна. Пока что доступны Telegram Stars.",
        "choose_rub_method": "Как заплатить?",
        "pay_method_sbp": "СБП | QR код",
        "sbp_invoice": "Оплата {rub}₽ за {days} дней.\nСсылка действительна {mins} минут. После оплаты подписка активируется автоматически.",
        "pay_now": "Оплатить",
        "sbp_expired": "Срок оплаты истёк. Оформите заказ заново.",
    ...
    "en": {
        ...
        "pay_stars_button": "Stars | {stars}⭐",
        "pay_sbp_button": "Platega | {rub}₽",
        "pay_sbp_button_soon": "Platega | {rub}₽ (soon)",
        "sbp_soon": "Ruble payments are coming soon. For now use Telegram Stars.",
        "choose_rub_method": "How to pay?",
        "pay_method_sbp": "SBP | QR code",
        "sbp_invoice": "Payment {rub}₽ for {days} days.\nThe link is valid for {mins} minutes. Your subscription activates automatically after payment.",
        "pay_now": "Pay",
        "sbp_expired": "The payment link has expired. Please start the order again.",
