...
class Server(Base):
    ...
    amnezia_enabled: Mapped[bool] = mapped_column(Boolean, default=False)
    amnezia_name: Mapped[str | None] = mapped_column(String(255), nullable=True)
    amnezia_endpoint_host: Mapped[str | None] = mapped_column(String(255), nullable=True)
    amnezia_port: Mapped[int | None] = mapped_column(Integer, nullable=True)
