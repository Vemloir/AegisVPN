# Graph Report - VPN  (2026-06-15)

## Corpus Check
- 83 files · ~36,991 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 752 nodes · 1655 edges · 38 communities (31 shown, 7 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 219 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dba137bd`
...
- [[_COMMUNITY_Payment Handlers|Payment Handlers]]
...
Cohesion: 0.19
Nodes (16): CallbackQuery, InlineKeyboardMarkup, Message, Inline keyboards for the end-user flow., subscription_keyboard(), cq_privacy_accept(), cq_privacy_show(), load_privacy_text() (+8 more)

### Community 2 - "Agent API & Connection Limits"
Cohesion: 0.05
Nodes (78): HTTPAuthorizationCredentials, HTTPAuthorizationCredentials, conn_limit_loop(), enforce_conn_limit_once(), _limit_for(), online_ips(), online_users(), Per-subscription simultaneous-connection limit.  Xray's StatsService reports eac (+70 more)

### Community 3 - "Bot Service Layer"
Cohesion: 0.05
Nodes (26): Subscription, User, Any, AsyncSession, Server, Subscription, User, AsyncSession (+18 more)

### Community 4 - "Bot App Entrypoint"
Cohesion: 0.11
Nodes (35): Application, AppRunner, AsyncIOScheduler, BaseMiddleware, Bot, Any, Bot, Dispatcher (+27 more)
...
Cohesion: 0.29
Nodes (17): CallbackQuery, InlineKeyboardMarkup, get_user_language(), _clean_label(), cq_device_detail(), cq_device_resume(), cq_device_suspend(), cq_devices_open() (+9 more)

### Community 32 - "Community 32"
Cohesion: 0.20
Nodes (17): CallbackQuery, Message, delete_account_keyboard(), language_keyboard(), reissue_subscription_keyboard(), settings_keyboard(), cmd_settings(), cq_account_delete() (+9 more)

### Community 33 - "Community 33"
Cohesion: 0.22
Nodes (17): CallbackQuery, InlineKeyboardMarkup, Message, subscription_detail_keyboard(), Returns True if the user may proceed; otherwise answers an alert., require_privacy(), cmd_subscription(), cq_help_setup() (+9 more)
...
Cohesion: 0.21
Nodes (9): language_label(), normalize_language(), set_user_language(), t(), test_language_label(), test_t_falls_back_to_ru_for_unknown_language(), test_t_formats_kwargs(), test_t_returns_translation() (+1 more)
